...
WPBMap::map( 'vc_column_text', array(
    ...
    "params"	=> array(
    	...
    	array(
    	    ...
    	    "param_name" => "icon",
    	    "value" => "",
    	    "description" => __("Icon to the left of the title text. You can get the code from <a href='http://fortawesome.github.com/Font-Awesome/' target='_blank'>here</a>. E.g. icon-cloud", "js_composer")
    	),
        array(
            "type" => "textarea_html",
            "holder" => "div",
